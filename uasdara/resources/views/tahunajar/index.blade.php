...
@section('content')
    <div class="card">
        ...
        <a href="/tahunajar/form/" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                            ...
                            <td>
                                ...
                                <div class="modal fade" id="detail{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Detail {{$item->tahunajar}}</h1>
                                        ...
                                        <div class="modal-body">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                        ...
                                                        <tr>
                                                            <td>Tahun Ajaran</td>
                                                            <th scope="row">{{$item->tahunajar}}</th>
                                                        </tr>
                                ...
                                <div class="modal fade" id="hapus{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                        Yakin ingin menghapus  <b>{{$item->tahunajar}}</b>?
                                        </div>
                                        <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                        <form action="/tahunajar/{{$item->id}}" method="post">
                                            @csrf
                                            @method('DELETE')
