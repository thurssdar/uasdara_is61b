...
@section('content')
    <div class="card">
        ...
        <a href="/matakuliah/form/" class="btn btn-warning"><i class="fa fa-plus"></i> Tambah Data</a>
                            ...
                            <td>
                                ...
                                <div class="modal fade" id="detail{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Detail {{$item->matakuliah}}</h1>
                                        ...
                                        <div class="modal-body">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                        ...
                                                        <tr>
                                                            <td>Mata Kuliah</td>
                                                            <th scope="row">{{$item->matakuliah}}</th>
                                                        </tr>
                                                        <tr>
                                                            <td>SKS</td>
                                                            <th scope="row">{{$item->sks}}</th>
                                                        </tr>
                                ...
                                <div class="modal fade" id="hapus{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                        Yakin ingin menghapus data mk <b>{{$item->matakuliah}}</b>?
                                        </div>
                                        <div class="modal-footer">
